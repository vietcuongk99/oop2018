package week4.task1;
/**
 * class này biểu diễn đối tượng Cam Sành kế thừa từ Cam
 * @see Cam
 */
public class CamSanh extends Cam{
    ...
    public CamSanh(String name, int number, int cost, String place, String date, int order) {
